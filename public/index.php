...
<head>
    ...
    <script type="text/javascript">
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=109774880', 'ym');
        ...
        <section id="feedback" class="section feedback">
            ...
            <div class="tiles">
                ...
                <div class="tile">
                    <img src="/assets/img/rating-5.svg">
                    <p class="comment">
                        «Сломался насос на станции Евролос. Мастер приехал на следующий день после заявки. Ребята организовали откачку, провели сервисное обслуживание и заменили насос. Однозначно рекомендую».
                    </p>
                    <p class="customer">
                        Евгений Котов<br><span>Владелец частного дома в Гатчине</span>
                    </p>
                </div>
                <div class="tile">
                    <img src="/assets/img/rating-5.svg">
                    <p class="comment">
                        «Каждый год заказываю обслуживание септика перед зимой, чтобы не было проблем при отрицательных температурах. Ребята все делают, как надо, до сих пор проблем не возникало.».
                    </p>
                    <p class="customer">
                        Ольга Смирнова<br><span>Владелец частного дома в СНТ «Грибное»</span>
                    </p>
                </div>
            </div>
        </section>
