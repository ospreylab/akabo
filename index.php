    ...
    <section class="feedback">
        ...
        <div class="reviews">
            <div class="review">
                ...
                <p class="text">
                    «Работаем уже 3 года. Замерщики всегда приезжают вовремя, результаты точные. Очень удобный личный кабинет — видим статусы всех заказов в реальном времени».
                </p>
                <p class="signature">
                    Алексей Иванов<br><span>Управляющий базой отдыха «Добрый лось»</span>
                </p>
            </div>
            <div class="review">
                <img src="/img/rating-5.png">
                <p class="text">
                    «Сотрудничаем по крупным объектам. Профессиональный подход, современное оборудование. Рекомендуем как надёжного партнёра».
                </p>
                <p class="signature">
                    Марина Козлова<br><span>Владелец загородного дома в КП «Северная долина»</span>
                </p>
            </div>
        </div>
    </section>
